const translations = {
    en: {
        ...
        label_over_right: "Over →",
        label_over_left: "Over ←",
        label_up: "Up ↑",
        ...
        label_old_pap_over_right: "Old PAP →",
        label_old_pap_over_left: "Old PAP ←",
        label_old_pap_up: "Old PAP ↑",

        label_new_pap_over_right: "New PAP →",
        label_new_pap_over_left: "New PAP ←",
        label_new_pap_up: "New PAP ↑",
        ...
        warn_invalid_input: "⚠️ Warning: Layout values are realistically impossible.",
        warn_unusual_output: "⚠️ Warning: Layout values are unusual.",
    },
    ko: {
        app_title: "지공 변환기",
        ...
        sec_adj_desc: "새로운 PAP 기준으로 레이아웃을 재계산합니다.",

        grp_initial: "기존 데이터",
        grp_new: "새 파라미터",

        label_old_pap_over_right: "기존 PAP →",
        label_old_pap_over_left: "기존 PAP ←",
        label_old_pap_up: "기존 PAP ↑",

        label_new_pap_over_right: "새 PAP →",
        label_new_pap_over_left: "새 PAP ←",
        label_new_pap_up: "새 PAP ↑",
        ...
        warn_invalid_input: "⚠️ 경고: 레이아웃 값이 현실적으로 불가능한 값입니다.",
        warn_unusual_output: "⚠️ 경고: 레이아웃 값이 일반적이지 않습니다.",
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    btn.addEventListener('click', () => {
        ...
        btn.textContent = currentLang === 'ko' ? "한국어" : "English";
        updateTexts();
    });
});
